...
export const services: Service[] = [
  ...
  },
  {
    ...
    fullDescription:
      'Follow-up consultations are essential for monitoring your progress and ensuring optimal results. Each session includes a reassessment of your condition, targeted chiropractic adjustments, and complementary therapies as needed.\n\nDr Pryce adjusts your treatment plan based on your response to care, ensuring you continue progressing toward your health goals. These appointments also include guidance on exercises, lifestyle modifications, and self-care strategies to support your healing between visits.',
    idealFor: [
      'Ongoing treatment',
      'Maintenance care',
      'Recovery monitoring',
